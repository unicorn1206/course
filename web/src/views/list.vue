                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a v-for="o in level1" v-bind:key="o.name" v-on:click="onClickLevel1(o.id)" v-bind:id="'category-' + o.id" href="javascript:;">{{o.name}}</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <a v-for="o in level2" v-bind:key="o.name" v-on:click="onClickLevel2(o.id)" v-bind:id="'category-' + o.id" href="javascript:;">{{o.name}}</a>
    ...
    export default {
        ...
        methods:{
            ...
            onClickLevel2(level2Id){
                ...
                //点击二级分类时，设置变量，用于课程筛选
                //如果点击的是【无限】，则二级分类id为空
                _this.level2Id = level2Id === '11111111' ? null : level2Id;
